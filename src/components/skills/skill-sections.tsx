    ...
    <div className="shell pb-20">
      <div className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
        <div className="space-y-6">
          <ListBlock title="适用场景" items={skill.scenarios} />
          <ListBlock title="使用方法" items={skill.howToUse} />
          <ListBlock title="输出结果" items={skill.outputs} />
          <ListBlock title="触发方式" items={skill.triggerPhrases} />
